...
export class ResponsesurveyComponent {
  ...
  constructor(private responseSurveyService : ResponseSurveyService ,private route: ActivatedRoute, private router: Router,  private notificationEmailService: NotificationEmailService, private http: HttpClient, private fb: FormBuilder){
    this.getAllStudent();
  }
  ...
  let respone = await emailjs.send('service_ztb5vrq','template_pftvmgp', {
